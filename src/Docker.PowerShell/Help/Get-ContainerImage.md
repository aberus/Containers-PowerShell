...
HelpUri: https://github.com/aberus/Containers-PowerShell/blob/master/src/Docker.PowerShell/Help/Get-ContainerImage.md
Locale: en-US
Module Name: Docker
ms.date: 08/29/2026
...
```
Get-ContainerImage [[-ImageIdOrName] <string[]>] [-HostAddress <string>] [-Context <string>]
...
```
Get-ContainerImage [-All] [-HostAddress <string>] [-Context <string>]
 [-CertificateLocation <string>] [<CommonParameters>]
```
